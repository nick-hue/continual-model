...
@dataclass
class MyMethodDataManagerConfig(VanillaDataManagerConfig):
    _target: Type = field(default_factory=lambda: MyMethodDataManager)
    patch_tile_size_range: Tuple[int, int] = (0.05, 0.5)
    patch_tile_size_res: int = 7
    patch_stride_scaler: float = 0.5


class MyMethodDataManager(VanillaDataManager):  # pylint: disable=abstract-method
    ...
    config: MyMethodDataManagerConfig
